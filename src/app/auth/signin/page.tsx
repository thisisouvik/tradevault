...
function SignInForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 overflow-hidden">
      ...
      <div className="w-full max-w-[1200px] mx-auto flex flex-col lg:flex-row items-center justify-center gap-12 px-6 lg:px-12 relative z-10 py-12">
        {/* Left Side: Login Card (Shifted Left) */}
        <motion.div
        ...
        <motion.div
          ...
          className="hidden lg:flex w-[600px] xl:w-[700px] flex-shrink-0 justify-center items-center"
        >
