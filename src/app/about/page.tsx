...
const values = [
  ...
  },
  {
    ...
    desc: 'TradeVault works for a freelancer in Lagos, a manufacturer in Shenzhen, and a buyer in Toronto. No bank account. No credit card. Just an Algorand wallet.',
  },
  {
    icon: BarChart3,
    color: '#8B5CF6',
    ...
    desc: 'Every state change — from deal creation to fund release — is a verifiable on-chain event. Anyone can audit any contract at any time on Algorand Explorer.',
  },
  {
    icon: Scale,
    color: '#F59E0B',
...
const features = [
  {
    ...
    desc: 'Sellers deploy tamper-proof Algorand contracts. Funds only move when cryptographic conditions are met.',
  },
  {
    icon: Wallet,
  ...
  },
  {
    ...
    desc: 'Tracking IDs are permanently hashed on the Algorand blockchain — cryptographic proof of delivery that can\'t be altered.',
  },
  {
    icon: CheckCircle2,
...
const timeline = [
  ...
  { year: '2025 Q1', label: 'v0.1 Launch', desc: 'First escrow contract deployed on Algorand Testnet. Core accept/fund/confirm flow live.' },
    ...
    <main className="flex min-h-screen flex-col bg-white">
      ...
      <section className="relative pt-32 pb-24 overflow-hidden bg-[#F7F9FC]">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            TradeVault is a blockchain-native escrow platform built for the global economy. We eliminate the need for banks, payment processors, or blind trust in strangers — replacing them with cryptographically enforced smart contracts on Algorand.
          </motion.p>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-[#3a7fa0] leading-relaxed font-medium mb-6">
              We built TradeVault to invert this completely. Instead of trusting a company, you trust code — open, verifiable, and immutable code running on the Algorand blockchain. The rules of the trade are locked in at creation and cannot be changed by anyone, including us.
            </p>
            <a
            ...
            >
              View live contracts on Algorand Explorer <ExternalLink className="w-4 h-4" />
            </a>
          </motion.div>
