...
const steps = [
  {
    ...
    description:
      'Fill in trade terms — item name, price in USDC, delivery deadline, dispute window, and the buyer\'s email or wallet. One click deploys a tamper-proof escrow directly to the Algorand blockchain. Terms are cryptographically sealed from this moment.',
    tag: 'PROPOSED',
    tagColor: '#64748b',
    highlights: ['Item details & USDC amount', 'Delivery & dispute window', 'Deployed to Algorand'],
  },
  {
    number: '02',
    actor: 'Buyer',
    ...
    description:
      'Open the contract link, connect your Algorand wallet, and click "Accept & Fund." Three atomic transactions execute simultaneously — your signed acceptance, a deal lock confirmation, and the USDC transfer to escrow. All three succeed together, or none do.',
    tag: 'FUNDED',
    tagColor: '#8B5CF6',
  ...
  },
  {
    ...
    description:
      'Goods arrived in agreed condition? Click "Confirm Receipt." The smart contract\'s inner transaction instantly transfers the full USDC amount to the seller\'s wallet. Algorand fee: $0.002. The contract is permanently archived on-chain as immutable proof of trade.',
    tag: 'COMPLETED',
    tagColor: '#10B981',
    ...
    <section id="how-it-works" className="py-24 sm:py-32 relative overflow-hidden bg-white border-b border-[#189AB4]/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-20">
          ...
          >
            No banks. No wire transfers. No trust required. Every step is cryptographically verified and permanently recorded on the Algorand blockchain.
          </motion.p>
        </div>
          ...
          >
            ...
            <div className="text-center sm:text-left">
              <p className="text-white font-extrabold text-base mb-1">
                Every path is protected by the Algorand blockchain.
              </p>
